...
main()
{
	...
	# build the itb image
	cp board/nxp/ls1028ardb/kernel-ls1028a-rdb-bm.its ${2}/
	cp output/images/fsl-ls1028a-rdb-sdk-bm.dtb ${2}/
	cp ${BINARIES_DIR}/rootfs.ext2.gz ${2}/fsl-image-core-ls1028ardb.ext2.gz
	cd ${2}/
	mkimage -f kernel-ls1028a-rdb-bm.its kernel-ls1028a-rdb.itb
	cd ${3}
	cp ${2}/kernel-ls1028a-rdb.itb ${BINARIES_DIR}/
	rm ${2}/fsl-image-core-ls1028ardb.ext2.gz
	rm ${2}/fsl-ls1028a-rdb-sdk-bm.dtb
	rm ${2}/kernel-ls1028a-rdb.itb
	rm ${2}/kernel-ls1028a-rdb-bm.its
	...
	local FILES=""kernel-ls1028a-rdb.itb", "version.json", "ls1028a-dp-fw.bin", "bm-u-boot.bin""

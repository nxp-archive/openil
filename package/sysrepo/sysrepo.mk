...
SYSREPO_CONF_OPTS = \
	...
	-DCALL_SYSREPOCTL_BIN=$(HOST_DIR)/usr/bin/sysrepoctl \
	-DCALL_SYSREPOCFG_BIN=$(HOST_DIR)/usr/bin/sysrepocfg \
...
SYSREPO_MAKE_ENV = LD_LIBRARY_PATH=$(HOST_DIR)/usr/lib:$(HOST_DIR)/lib

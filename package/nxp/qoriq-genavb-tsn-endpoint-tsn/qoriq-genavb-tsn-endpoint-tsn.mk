...
QORIQ_GENAVB_TSN_ENDPOINT_TSN_LICENSE = Proprietary (binaries), BSD-3-Clause (apps, scripts, public headers), GPL-2.0 (modules)
QORIQ_GENAVB_TSN_ENDPOINT_TSN_LICENSE_FILES = EULA.txt, linux/modules/COPYING
...
define QORIQ_GENAVB_TSN_ENDPOINT_TSN_INSTALL_TARGET_CMDS
	...
	ln -snf $(TARGET_DIR)/usr/lib/libgenavb.so.1.0 $(TARGET_DIR)/usr/lib/libgenavb.so.1

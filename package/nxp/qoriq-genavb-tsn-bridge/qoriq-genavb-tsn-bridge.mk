...
QORIQ_GENAVB_TSN_BRIDGE_LICENSE = Proprietary (binaries), BSD-3-Clause (include, apps, scripts, public), GPL-2.0 (modules)
QORIQ_GENAVB_TSN_BRIDGE_LICENSE_FILES = licenses/EULA.txt, licenses/COPYING, licenses/BSD-3-Clause
